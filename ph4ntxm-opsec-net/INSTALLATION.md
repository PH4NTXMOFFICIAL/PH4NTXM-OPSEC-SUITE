...
PH4NTXM-OpSec is a network-focused operational security module designed for Debian-based systems. It provides runtime checks and optional remediation aligned with PH4NTXM operational assumptions.
...
The module includes optional remediation actions for reducing network exposure and responding to potentially unsafe network conditions.  
Available remediation actions may include enabling network lockdown mode, disabling network lockdown mode, blocking incoming and outgoing network traffic, or reducing external network exposure during active threats or investigation.  
