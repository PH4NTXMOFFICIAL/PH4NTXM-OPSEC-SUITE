...
PH4NTXM-OpSec is a radio-frequency-focused operational security module designed for Debian-based systems. It provides runtime checks and optional remediation aligned with PH4NTXM operational assumptions.
...
The module includes optional remediation actions for reducing radio-frequency exposure and restoring safer operating states.  
Available remediation actions may include disabling Bluetooth, disabling WiFi, disabling WWAN/modem radios, disabling NFC, disabling modem-assisted GPS, or disabling wireless monitor mode.  
